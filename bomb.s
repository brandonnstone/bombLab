...
0000000000400e4d <main>:
  ...
  400f27:	e8 de 00 00 00       	callq  40100a <phase_3>
  ...
  400f43:	e8 84 01 00 00       	callq  4010cc <phase_4>
  ...
  400f5f:	e8 bd 01 00 00       	callq  401121 <phase_5>
  ...
  400f7b:	e8 2e 02 00 00       	callq  4011ae <phase_6>
...
0000000000400fa0 <phase_1>:
  ...
  400fa4:	be 4c 27 40 00       	mov    $0x40274c,%esi
...
0000000000400fb9 <phase_2>:
  ...
  400fcd:	83 7d d0 01          	cmpl   $0x1,-0x30(%rbp)
  400fd1:	74 20                	je     400ff3 <phase_2+0x3a>
  400fd3:	e8 1d 07 00 00       	callq  4016f5 <explode_bomb>
  400fd8:	eb 19                	jmp    400ff3 <phase_2+0x3a>
  400fda:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400fdd:	01 c0                	add    %eax,%eax
  400fdf:	39 03                	cmp    %eax,(%rbx)
  400fe1:	74 05                	je     400fe8 <phase_2+0x2f>
  400fe3:	e8 0d 07 00 00       	callq  4016f5 <explode_bomb>
  400fe8:	48 83 c3 04          	add    $0x4,%rbx
  400fec:	4c 39 e3             	cmp    %r12,%rbx
  400fef:	75 e9                	jne    400fda <phase_2+0x21>
  400ff1:	eb 0e                	jmp    401001 <phase_2+0x48>
  400ff3:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
  400ff7:	48 8d 58 04          	lea    0x4(%rax),%rbx
  400ffb:	4c 8d 60 18          	lea    0x18(%rax),%r12
  400fff:	eb d9                	jmp    400fda <phase_2+0x21>
  401001:	48 83 c4 20          	add    $0x20,%rsp
  401005:	5b                   	pop    %rbx
  401006:	41 5c                	pop    %r12
  401008:	5d                   	pop    %rbp
  401009:	c3                   	retq   

000000000040100a <phase_3>:
  40100a:	55                   	push   %rbp
  40100b:	48 89 e5             	mov    %rsp,%rbp
  40100e:	48 83 ec 10          	sub    $0x10,%rsp
  401012:	48 8d 4d fc          	lea    -0x4(%rbp),%rcx
  401016:	48 8d 55 f8          	lea    -0x8(%rbp),%rdx
  40101a:	be 35 2a 40 00       	mov    $0x402a35,%esi
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 87 fc ff ff       	callq  400cb0 <__isoc99_sscanf@plt>
  401029:	83 f8 01             	cmp    $0x1,%eax
  40102c:	7f 05                	jg     401033 <phase_3+0x29>
  40102e:	e8 c2 06 00 00       	callq  4016f5 <explode_bomb>
  401033:	83 7d f8 07          	cmpl   $0x7,-0x8(%rbp)
  401037:	77 3b                	ja     401074 <phase_3+0x6a>
  401039:	8b 45 f8             	mov    -0x8(%rbp),%eax
  40103c:	ff 24 c5 70 27 40 00 	jmpq   *0x402770(,%rax,8)
  401043:	b8 08 03 00 00       	mov    $0x308,%eax
  401048:	eb 3b                	jmp    401085 <phase_3+0x7b>
  40104a:	b8 50 03 00 00       	mov    $0x350,%eax
  40104f:	eb 34                	jmp    401085 <phase_3+0x7b>
  401051:	b8 cf 02 00 00       	mov    $0x2cf,%eax
  401056:	eb 2d                	jmp    401085 <phase_3+0x7b>
  401058:	b8 ce 01 00 00       	mov    $0x1ce,%eax
  40105d:	eb 26                	jmp    401085 <phase_3+0x7b>
  40105f:	b8 9e 00 00 00       	mov    $0x9e,%eax
  401064:	eb 1f                	jmp    401085 <phase_3+0x7b>
  401066:	b8 9c 00 00 00       	mov    $0x9c,%eax
  40106b:	eb 18                	jmp    401085 <phase_3+0x7b>
  40106d:	b8 b5 01 00 00       	mov    $0x1b5,%eax
  401072:	eb 11                	jmp    401085 <phase_3+0x7b>
  401074:	e8 7c 06 00 00       	callq  4016f5 <explode_bomb>
  401079:	b8 00 00 00 00       	mov    $0x0,%eax
  40107e:	eb 05                	jmp    401085 <phase_3+0x7b>
  401080:	b8 f5 02 00 00       	mov    $0x2f5,%eax
  401085:	3b 45 fc             	cmp    -0x4(%rbp),%eax
  401088:	74 05                	je     40108f <phase_3+0x85>
  40108a:	e8 66 06 00 00       	callq  4016f5 <explode_bomb>
  40108f:	c9                   	leaveq 
  401090:	c3                   	retq   

0000000000401091 <func4>:
  401091:	55                   	push   %rbp
  401092:	48 89 e5             	mov    %rsp,%rbp
  401095:	89 d0                	mov    %edx,%eax
  401097:	29 f0                	sub    %esi,%eax
  401099:	89 c1                	mov    %eax,%ecx
  40109b:	c1 e9 1f             	shr    $0x1f,%ecx
  40109e:	01 c8                	add    %ecx,%eax
  4010a0:	d1 f8                	sar    %eax
  4010a2:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx
  4010a5:	39 f9                	cmp    %edi,%ecx
  4010a7:	7e 0c                	jle    4010b5 <func4+0x24>
  4010a9:	8d 51 ff             	lea    -0x1(%rcx),%edx
  4010ac:	e8 e0 ff ff ff       	callq  401091 <func4>
  4010b1:	01 c0                	add    %eax,%eax
  4010b3:	eb 15                	jmp    4010ca <func4+0x39>
  4010b5:	b8 00 00 00 00       	mov    $0x0,%eax
  4010ba:	39 f9                	cmp    %edi,%ecx
  4010bc:	7d 0c                	jge    4010ca <func4+0x39>
  4010be:	8d 71 01             	lea    0x1(%rcx),%esi
  4010c1:	e8 cb ff ff ff       	callq  401091 <func4>
  4010c6:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  4010ca:	5d                   	pop    %rbp
  4010cb:	c3                   	retq   

00000000004010cc <phase_4>:
  4010cc:	55                   	push   %rbp
  4010cd:	48 89 e5             	mov    %rsp,%rbp
  4010d0:	48 83 ec 10          	sub    $0x10,%rsp
  4010d4:	48 8d 4d fc          	lea    -0x4(%rbp),%rcx
  4010d8:	48 8d 55 f8          	lea    -0x8(%rbp),%rdx
  4010dc:	be 35 2a 40 00       	mov    $0x402a35,%esi
  4010e1:	b8 00 00 00 00       	mov    $0x0,%eax
  4010e6:	e8 c5 fb ff ff       	callq  400cb0 <__isoc99_sscanf@plt>
  4010eb:	83 f8 02             	cmp    $0x2,%eax
  4010ee:	75 06                	jne    4010f6 <phase_4+0x2a>
  4010f0:	83 7d f8 0e          	cmpl   $0xe,-0x8(%rbp)
  4010f4:	76 05                	jbe    4010fb <phase_4+0x2f>
  4010f6:	e8 fa 05 00 00       	callq  4016f5 <explode_bomb>
  4010fb:	ba 0e 00 00 00       	mov    $0xe,%edx
  401100:	be 00 00 00 00       	mov    $0x0,%esi
  401105:	8b 7d f8             	mov    -0x8(%rbp),%edi
  401108:	e8 84 ff ff ff       	callq  401091 <func4>
  40110d:	83 f8 07             	cmp    $0x7,%eax
  401110:	75 06                	jne    401118 <phase_4+0x4c>
  401112:	83 7d fc 07          	cmpl   $0x7,-0x4(%rbp)
  401116:	74 05                	je     40111d <phase_4+0x51>
  401118:	e8 d8 05 00 00       	callq  4016f5 <explode_bomb>
  40111d:	c9                   	leaveq 
  40111e:	66 90                	xchg   %ax,%ax
  401120:	c3                   	retq   

0000000000401121 <phase_5>:
  401121:	55                   	push   %rbp
  ...
  40113c:	e8 9a 02 00 00       	callq  4013db <string_length>
  401141:	83 f8 06             	cmp    $0x6,%eax
  401144:	74 45                	je     40118b <phase_5+0x6a>
  401146:	e8 aa 05 00 00       	callq  4016f5 <explode_bomb>
  40114b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  401150:	eb 39                	jmp    40118b <phase_5+0x6a>
  401152:	0f b6 14 03          	movzbl (%rbx,%rax,1),%edx
  401156:	83 e2 0f             	and    $0xf,%edx
  401159:	0f b6 92 b0 27 40 00 	movzbl 0x4027b0(%rdx),%edx
  401160:	88 54 05 e0          	mov    %dl,-0x20(%rbp,%rax,1)
  401164:	48 83 c0 01          	add    $0x1,%rax
  401168:	48 83 f8 06          	cmp    $0x6,%rax
  40116c:	75 e4                	jne    401152 <phase_5+0x31>
  40116e:	c6 45 e6 00          	movb   $0x0,-0x1a(%rbp)
  401172:	be 60 27 40 00       	mov    $0x402760,%esi
  401177:	48 8d 7d e0          	lea    -0x20(%rbp),%rdi
  40117b:	e8 7d 02 00 00       	callq  4013fd <strings_not_equal>
  401180:	85 c0                	test   %eax,%eax
  401182:	74 0e                	je     401192 <phase_5+0x71>
  401184:	e8 6c 05 00 00       	callq  4016f5 <explode_bomb>
  401189:	eb 07                	jmp    401192 <phase_5+0x71>
  40118b:	b8 00 00 00 00       	mov    $0x0,%eax
  401190:	eb c0                	jmp    401152 <phase_5+0x31>
  401192:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  401196:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
  40119d:	00 00 
  40119f:	90                   	nop
  4011a0:	74 05                	je     4011a7 <phase_5+0x86>
  4011a2:	e8 39 fa ff ff       	callq  400be0 <__stack_chk_fail@plt>
...
00000000004011ae <phase_6>:
  ...
  4011b2:	41 57                	push   %r15
  4011b4:	41 56                	push   %r14
  4011b6:	41 55                	push   %r13
  4011b8:	41 54                	push   %r12
  4011ba:	53                   	push   %rbx
  4011bb:	48 83 ec 58          	sub    $0x58,%rsp
  4011bf:	4c 8d 75 80          	lea    -0x80(%rbp),%r14
  4011c3:	4c 89 f6             	mov    %r14,%rsi
  4011c6:	e8 60 05 00 00       	callq  40172b <read_six_numbers>
  4011cb:	4d 89 f7             	mov    %r14,%r15
  4011ce:	41 bd 00 00 00 00    	mov    $0x0,%r13d
  4011d4:	4d 89 f4             	mov    %r14,%r12
  4011d7:	41 8b 06             	mov    (%r14),%eax
  4011da:	83 e8 01             	sub    $0x1,%eax
  4011dd:	83 f8 05             	cmp    $0x5,%eax
  4011e0:	76 05                	jbe    4011e7 <phase_6+0x39>
  4011e2:	e8 0e 05 00 00       	callq  4016f5 <explode_bomb>
  4011e7:	41 83 c5 01          	add    $0x1,%r13d
  4011eb:	41 83 fd 06          	cmp    $0x6,%r13d
  4011ef:	74 23                	je     401214 <phase_6+0x66>
  4011f1:	44 89 eb             	mov    %r13d,%ebx
  4011f4:	48 63 c3             	movslq %ebx,%rax
  4011f7:	8b 44 85 80          	mov    -0x80(%rbp,%rax,4),%eax
  4011fb:	41 39 04 24          	cmp    %eax,(%r12)
  4011ff:	75 05                	jne    401206 <phase_6+0x58>
  401201:	e8 ef 04 00 00       	callq  4016f5 <explode_bomb>
  401206:	83 c3 01             	add    $0x1,%ebx
  401209:	83 fb 05             	cmp    $0x5,%ebx
  40120c:	7e e6                	jle    4011f4 <phase_6+0x46>
  40120e:	49 83 c6 04          	add    $0x4,%r14
  401212:	eb c0                	jmp    4011d4 <phase_6+0x26>
  401214:	48 8d 4d 98          	lea    -0x68(%rbp),%rcx
  401218:	ba 07 00 00 00       	mov    $0x7,%edx
  40121d:	89 d0                	mov    %edx,%eax
  40121f:	41 2b 07             	sub    (%r15),%eax
  401222:	41 89 07             	mov    %eax,(%r15)
  401225:	49 83 c7 04          	add    $0x4,%r15
  401229:	49 39 cf             	cmp    %rcx,%r15
  40122c:	75 ef                	jne    40121d <phase_6+0x6f>
  40122e:	be 00 00 00 00       	mov    $0x0,%esi
  401233:	eb 21                	jmp    401256 <phase_6+0xa8>
  401235:	48 8b 52 08          	mov    0x8(%rdx),%rdx
  401239:	83 c0 01             	add    $0x1,%eax
  40123c:	39 c8                	cmp    %ecx,%eax
  40123e:	75 f5                	jne    401235 <phase_6+0x87>
  401240:	eb 05                	jmp    401247 <phase_6+0x99>
  401242:	ba 10 43 60 00       	mov    $0x604310,%edx
  401247:	48 89 54 75 a0       	mov    %rdx,-0x60(%rbp,%rsi,2)
  40124c:	48 83 c6 04          	add    $0x4,%rsi
  401250:	48 83 fe 18          	cmp    $0x18,%rsi
  401254:	74 15                	je     40126b <phase_6+0xbd>
  401256:	8b 4c 35 80          	mov    -0x80(%rbp,%rsi,1),%ecx
  40125a:	83 f9 01             	cmp    $0x1,%ecx
  40125d:	7e e3                	jle    401242 <phase_6+0x94>
  40125f:	b8 01 00 00 00       	mov    $0x1,%eax
  401264:	ba 10 43 60 00       	mov    $0x604310,%edx
  401269:	eb ca                	jmp    401235 <phase_6+0x87>
  40126b:	48 8b 5d a0          	mov    -0x60(%rbp),%rbx
  40126f:	48 8d 45 a8          	lea    -0x58(%rbp),%rax
  401273:	48 8d 75 d0          	lea    -0x30(%rbp),%rsi
  401277:	48 89 d9             	mov    %rbx,%rcx
  40127a:	48 8b 10             	mov    (%rax),%rdx
  40127d:	48 89 51 08          	mov    %rdx,0x8(%rcx)
  401281:	48 83 c0 08          	add    $0x8,%rax
  401285:	48 39 f0             	cmp    %rsi,%rax
  401288:	74 05                	je     40128f <phase_6+0xe1>
  40128a:	48 89 d1             	mov    %rdx,%rcx
  40128d:	eb eb                	jmp    40127a <phase_6+0xcc>
  40128f:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  401296:	00 
  401297:	41 bc 05 00 00 00    	mov    $0x5,%r12d
  40129d:	48 8b 43 08          	mov    0x8(%rbx),%rax
  4012a1:	8b 00                	mov    (%rax),%eax
  4012a3:	39 03                	cmp    %eax,(%rbx)
  4012a5:	7d 05                	jge    4012ac <phase_6+0xfe>
  4012a7:	e8 49 04 00 00       	callq  4016f5 <explode_bomb>
  4012ac:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4012b0:	41 83 ec 01          	sub    $0x1,%r12d
  4012b4:	75 e7                	jne    40129d <phase_6+0xef>
  4012b6:	48 83 c4 58          	add    $0x58,%rsp
  4012ba:	5b                   	pop    %rbx
...
00000000004012c5 <fun7>:
  4012c5:	55                   	push   %rbp
  4012c6:	48 89 e5             	mov    %rsp,%rbp
  4012c9:	48 85 ff             	test   %rdi,%rdi
  4012cc:	74 2b                	je     4012f9 <fun7+0x34>
  4012ce:	8b 17                	mov    (%rdi),%edx
  4012d0:	39 f2                	cmp    %esi,%edx
  4012d2:	7e 0d                	jle    4012e1 <fun7+0x1c>
  4012d4:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  4012d8:	e8 e8 ff ff ff       	callq  4012c5 <fun7>
  4012dd:	01 c0                	add    %eax,%eax
  4012df:	eb 1d                	jmp    4012fe <fun7+0x39>
  4012e1:	b8 00 00 00 00       	mov    $0x0,%eax
  4012e6:	39 f2                	cmp    %esi,%edx
  4012e8:	74 14                	je     4012fe <fun7+0x39>
  4012ea:	48 8b 7f 10          	mov    0x10(%rdi),%rdi
  4012ee:	e8 d2 ff ff ff       	callq  4012c5 <fun7>
  4012f3:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  4012f7:	eb 05                	jmp    4012fe <fun7+0x39>
  4012f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4012fe:	5d                   	pop    %rbp
  4012ff:	c3                   	retq   

0000000000401300 <secret_phase>:
  401300:	55                   	push   %rbp
  401301:	48 89 e5             	mov    %rsp,%rbp
  401304:	53                   	push   %rbx
  401305:	48 83 ec 08          	sub    $0x8,%rsp
  401309:	e8 63 04 00 00       	callq  401771 <read_line>
  40130e:	ba 0a 00 00 00       	mov    $0xa,%edx
  401313:	be 00 00 00 00       	mov    $0x0,%esi
  401318:	48 89 c7             	mov    %rax,%rdi
  40131b:	e8 70 f9 ff ff       	callq  400c90 <strtol@plt>
  401320:	48 89 c3             	mov    %rax,%rbx
  401323:	8d 40 ff             	lea    -0x1(%rax),%eax
  401326:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  40132b:	76 05                	jbe    401332 <secret_phase+0x32>
  40132d:	e8 c3 03 00 00       	callq  4016f5 <explode_bomb>
  401332:	89 de                	mov    %ebx,%esi
  401334:	bf 30 41 60 00       	mov    $0x604130,%edi
  401339:	e8 87 ff ff ff       	callq  4012c5 <fun7>
  40133e:	83 f8 01             	cmp    $0x1,%eax
  401341:	74 05                	je     401348 <secret_phase+0x48>
  401343:	e8 ad 03 00 00       	callq  4016f5 <explode_bomb>
  401348:	bf c0 27 40 00       	mov    $0x4027c0,%edi
  40134d:	e8 6e f8 ff ff       	callq  400bc0 <puts@plt>
  401352:	e8 3d 05 00 00       	callq  401894 <phase_defused>
...
0000000000401360 <sig_handler>:
  ...
  4013a2:	bf b9 29 40 00       	mov    $0x4029b9,%edi
...
00000000004013b6 <invalid_phase>:
  ...
  4013bd:	be c1 29 40 00       	mov    $0x4029c1,%esi
...
000000000040146d <initialize_bomb>:
  ...
  4014bf:	bf 20 28 40 00       	mov    $0x402820,%edi
  ...
  4014f9:	be d2 29 40 00       	mov    $0x4029d2,%esi
  ...
  401517:	bf 58 28 40 00       	mov    $0x402858,%edi
...
00000000004015f1 <send_msg>:
  ...
  401649:	be 90 28 40 00       	mov    $0x402890,%esi
  ...
  401665:	b8 ec 29 40 00       	mov    $0x4029ec,%eax
  40166a:	41 b9 f4 29 40 00    	mov    $0x4029f4,%r9d
  ...
  401683:	b9 fd 29 40 00       	mov    $0x4029fd,%ecx
...
000000000040172b <read_six_numbers>:
  ...
  401753:	be 29 2a 40 00       	mov    $0x402a29,%esi
...
0000000000401771 <read_line>:
  ...
  4017de:	bf 3b 2a 40 00       	mov    $0x402a3b,%edi
  ...
  401827:	bf 64 2a 40 00       	mov    $0x402a64,%edi
...
0000000000401894 <phase_defused>:
  ...
  4018ca:	be 7f 2a 40 00       	mov    $0x402a7f,%esi
  ...
  4018e3:	be 88 2a 40 00       	mov    $0x402a88,%esi
  ...
  4018f5:	bf e0 28 40 00       	mov    $0x4028e0,%edi
  4018fa:	e8 c1 f2 ff ff       	callq  400bc0 <puts@plt>
  4018ff:	bf 08 29 40 00       	mov    $0x402908,%edi
  401904:	e8 b7 f2 ff ff       	callq  400bc0 <puts@plt>
  401909:	b8 00 00 00 00       	mov    $0x0,%eax
  40190e:	e8 ed f9 ff ff       	callq  401300 <secret_phase>
  401913:	bf 40 29 40 00       	mov    $0x402940,%edi
  401918:	e8 a3 f2 ff ff       	callq  400bc0 <puts@plt>
  40191d:	bf 70 29 40 00       	mov    $0x402970,%edi
...
0000000000401950 <sigalrm_handler>:
  ...
  401959:	ba b0 2a 40 00       	mov    $0x402ab0,%edx
...
0000000000401a9c <submitr>:
  ...
  401e06:	b9 88 2b 40 00       	mov    $0x402b88,%ecx
  ...
  401fbc:	be 8f 2b 40 00       	mov    $0x402b8f,%esi
  ...
  401fed:	b9 d8 2a 40 00       	mov    $0x402ad8,%ecx
  ...
  4021e4:	b9 08 2b 40 00       	mov    $0x402b08,%ecx
...
0000000000402310 <init_driver>:
  ...
  4023ca:	bf 98 2a 40 00       	mov    $0x402a98,%edi
  ...
  40247e:	66 c7 45 d2 4e cb    	movw   $0xcb4e,-0x2e(%rbp)
  ...
  402498:	41 b8 98 2a 40 00    	mov    $0x402a98,%r8d
  40249e:	b9 60 2b 40 00       	mov    $0x402b60,%ecx
...
0000000000402500 <driver_post>:
  ...
  402510:	be a0 2b 40 00       	mov    $0x402ba0,%esi
  ...
  402547:	41 b9 b7 2b 40 00    	mov    $0x402bb7,%r9d
  40254d:	49 89 f0             	mov    %rsi,%r8
  402550:	48 89 f9             	mov    %rdi,%rcx
  402553:	ba c2 2b 40 00       	mov    $0x402bc2,%edx
  402558:	be cb 4e 00 00       	mov    $0x4ecb,%esi
  40255d:	bf 98 2a 40 00       	mov    $0x402a98,%edi
